  ...
  <section class="section profile">
    ...
    <div class="card">
      <div class="card-body pt-3">
        <?php echo form_open('admin/insert-volume', ['enctype' => 'multipart/form-data']);?>
        <div class="row mb-3">
            <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Cover Image</label>
            <div class="col-md-8 col-lg-9">
                <img id="profileImg" src="<?= base_url('assets/img/apple-touch-icon.png') ?>" alt="Profile" style="width: 100px; height: 150px;">
                <div class="pt-2">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-8 col-lg-9">
            <input name="vol_name" type="text" class="form-control" id="card-title">
          </div>
        </div>
